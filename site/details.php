...
<body>
     ...
     <div class="mx-auto container bg-gray-400 flex justify-between ">
        <div class="p-4">
            <img class="h-12 w-40" src="../content../content/img/Screen Shot 2022-09-21 at 01.33 1.png" alt="">
        </div>
        <div class="flex p-4 ">
    ...
    <div class="mx-auto container p-4">
        ...
        <div class="grid grid-cols-2 gap-10">
            <div class="p-4">
                <img class="pt-4 max-width max-height-details" src="../content/img/image 5.png" alt="">
            </div>
            <!-- thông tin -->
            <div class="p-4">
                <h1 class=" font-medium pt-2 text-lg">Áo sơ mi</h1>
                <!-- masp -->
                <h1 class=" font-medium py-2 text-lg text-orange-500">MSP:ASMTN 01
                </h1>
                <!-- kieu ao -->
        ...
        <p class="font-medium">- Áo sơ mi ngắn tay phom Regular fit suông vừa, giúp người mặc thoải mái mà vẫn vừa vặn số đo hình thể.
        </p>
        <p class="font-medium">-Thiết kế tà lượn, có túi ngực. Áo được in họa tiết trắng kẻ xanh sắc nét và ấn tượng, mang đến diện mạo lịch lãm cho quý ông.</p>
        <p class="font-medium  py-2">Chất liệu:</p>
        <p class="font-medium  ">- 50% chất liệu Modal từ sợi sồi thiên nhiên cho bề mặt vải mềm mại, nhẹ và thoáng khí</p>
        <p class="font-medium  ">- 50% Polyester giúp áo bền màu, sắc nét và độ trơn trượt, mỏng nhẹ.
        </p>
        ...
        <p class="font-medium  py-2">Size: 38/39/40/41/42/43</p>
         ...
         <div class="p-4">
            <p class="font-medium text-lg">Tên:vietnq</p>
            <p class="font-medium pb-2">Sản phẩm đẹp chất liệu mát</p>
            <p class="font-medium text-lg">Tên:thaolm</p>
            <p class="font-medium pb-2">Áo mặc vừa vải đẹp không nhăn</p>
            <p class="font-medium text-lg">Tên:hieunm</p>
            <p class="font-medium pb-2">Áo co dãn mặc thoải mái lắm.</p>
         </div>
