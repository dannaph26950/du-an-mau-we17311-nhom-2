    ...
    <div class="mx-auto container py-4">
            ...
            <?php foreach ($cate as $key => $value) { ?>
                <a href="product.html" class="">
                    <div class="hover:shadow-2xl hover:rounded-2xl ">
                        <center>
                            <img class="pt-4 w-[300px] h-[300px]" src="<?php echo $value['categories_img'] ?>" alt="">
                        </center>
                        <h1 class="text-center font-medium py-4 text-xl"><?php echo $value['name'] ?></h1>
                    </div>
                </a>
            <?php } ?>
        ...
        <div class="p-4 text-center">
            ...
            <nav class="justify-center flex gap-10 p-4 font-medium text-xl">
                <?php foreach ($cateAll as $key => $value) { ?>
                    <a href="" class="list-none text-red-600 hover:bg-red-600 hover:text-white  p-2 hover:rounded-md"><?= $value['name'] ?></a>
                <?php } ?>
            </nav>
        </div>
        <!-- list sp -->
        <div class="grid grid-cols-4 gap-8 p-4">
            ...
            <?php foreach ($products as $key => $value) { ?>
                <a href="details.php?id=<?= $value['id'] ?>" class="">
                    ...
                    <div class="hover:shadow-2xl hover:rounded-2xl ">
                        <center>
                            <img class="pt-4 w-[300px] h-[300px]" src="<?php foreach($products_img as $key =>$val){
                        ...
                        <h1 class="text-center font-medium pt-2 text-lg"><?php echo $value['name'] ?></h1>
                        <!-- MSP -->
