...
<body>
    ...
    <div class="mx-auto container py-4">
        <h1 class="px-4 text-2xl font-medium">Danh mục nổi bật</h1>
        <div class="grid grid-cols-4 gap-8 p-4">
            <a href="product.html" class="">
                <div class="hover:shadow-2xl hover:rounded-2xl ">
                    <center>
                        <img class="pt-4" src="../content/img/image 1.png" alt="">
                    </center>
                    <h1 class="text-center font-medium py-4 text-xl">Áo sơ mi</h1>
                </div>
            </a>
            <a href="product.html" class="">
                <div class="hover:shadow-2xl hover:rounded-2xl ">
                    <center>
                        <img class="pt-4" src="../content/img/image 2.png" alt="">
                    </center>
                    <h1 class="text-center font-medium py-4 text-xl">Áo Polo</h1>
                </div>
            </a> <a href="product.html" class="">
                <div class="hover:shadow-2xl hover:rounded-2xl ">
                    <center>
                        <img class="pt-4" src="../content/img/image 3.png" alt="">
                    </center>
                    <h1 class="text-center font-medium py-4 text-xl">Áo len</h1>
                </div>
            </a> 
            <a href="product.html" class="">
                <div class="hover:shadow-2xl hover:rounded-2xl ">
                    <center>
                        <img class="pt-4" src="../content/img/image 4.png" alt="">
                    </center>
                    <h1 class="text-center font-medium py-4 text-xl">Áo khoác</h1>
                </div>
            </a>
        ...
        <div class="p-4 text-center">
            ...
            <nav class="justify-center flex gap-10 p-4 font-medium text-xl">
                <a href="" class="list-none text-red-600 hover:bg-red-600 hover:text-white  p-2 hover:rounded-md">Tất
                    cả</a>
                <a href=""
                    class="list-none  text-orange-500  hover:bg-red-600 hover:text-white p-2 hover:rounded-md">Thu đông
                    2022</a>
                <a href=""
                    class="list-none text-orange-500  hover:bg-red-600 hover:text-white  p-2 hover:rounded-md">Xuân hè
                    2022</a>

                <a href=""
                    class="list-none text-orange-500  hover:bg-red-600 hover:text-white  p-2 hover:rounded-md">Set</a>
